...
t_student_classes <- function(df, classes, cr_a, cr_b, col_names = c("A", "B", "p_value", "Fold-Change")){
...
colnames(aux_mat) <- colnames(df);

# Construcción de mapa de calor.
colors_h <- colorRampPalette(c("darkBlue", "white", "darkred"))(16);
h_breaks <- seq(from=-2, to=2, length = 17);
